...
\begin{frame}
  \frametitle{Your expectations (Fall 2024)}
...
\begin{frame}
  ...
  We will begin our introduction to MATLAB via basic statistical analyses.
  \pause
...
\begin{frame}
  \frametitle{Example 2: Iris dataset}
