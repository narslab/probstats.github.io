...
\begin{frame}
  ...
  \begin{eqnarray}
    \label{eq:17b}
        P(A \cup B) &=& P(A) + P(B) - P(AB) \\[2mm] \pause
    P(A \cup B|E) &=& P(A|E) + P(B|E) - P(AB|E)
  \end{eqnarray}
\end{frame}
...
\begin{frame}
  ...
  \begin{alertblock}{Statistically independent events}
    IF $A$ and $B$ are statistically independent, the multiplication rule becomes: \pause
    \begin{equation}
      \label{eq:15}
      P(AB) = P(A)P(B)
    \end{equation}
...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:17}
    P(A {\rd B|E}) = P(A| {\rd B|E})P({\rd B|E})
  \end{equation}

  \pause
  \begin{alertblock}{Statistically independent events}
    If $A$ and $B$ are statistically independent, the multiplication rule for two events conditioned on the same space becomes: \pause
    \begin{equation}
      \label{eq:18}
      P(AB|E) = P(A|E)P(B|E)
    \end{equation}
...
\begin{frame}
  ...
  Bayes' Theorem allows for the computation of an inverse probability, e.g. given $P(E|A)$, can we find $P(A|E)$?
  ...
  \begin{equation}
    \label{eq:25}
    {\pl P(A_i|E)} =\fr{{\rd P(E|A_i)}{\bl P(A_i)}}{\gr \sum_{j=1}^{n}P(E|A_j)P(A_j)} 
        = \pause \fr{{\rd P(E|A_i)}{\bl P(A_{i})}}{\gr P(E)}
  \end{equation}
  \vspace{-3ex}
  \pause
  \begin{itemize}[<+->]
  \item {\bf posterior probability: $\pl P(A_i|E)$}
  \item {\bf likelihood: $\rd P(E|A_{i})$}
  \item {\bf prior: $\bl P(A_{i})$}
  \item {\bf evidence (total probability): $\gr P(E)$}
  \end{itemize}   
    \end{minipage}\quad
...
If the event $E$ can be conditioned on only two events $A$ and $B$, then: \pause

\begin{eqnarray}
  {\pl P(A|E)} &=& \pause \fr{{\rd P(E|A)}{\bl P(A)}}{\gr P(E|A)P(A) + P(E|B) P(B)} \\[2mm] \pause
  {\pl P(B|E)} &=& \pause \fr{{\rd P(E|B)}{\bl P(B)}}{\gr P(E|A)P(A) + P(E|B) P(B)}  
\end{eqnarray}
\end{frame}
...
\begin{frame}
  ...
  \item Total probability:
    \begin{equation}
      P(E) = P(E|A_{1})P(A_{1}) + P(E|A_{2})P(A_{2}) + \cdots + P(E|A_{n})P(A_{n})
    \end{equation}

  \item Bayes' Theorem:
    \begin{equation}
      P(A_{1}|E) = \fr{P(E|A_{1})P(A_{1})}{ P(E|A_{1})P(A_{1}) + P(E|A_{2})P(A_{2}) + \cdots + P(E|A_{n})P(A_{n})}
    \end{equation}
