...
\begin{frame}
  \frametitle{Module 3: Probability Distributions}
  \pause

  \begin{itemize}
  \item M3a:  Introduction: Random Variables \pause
  \item M3b: Normal Distribution \pause
  \item M3c: Lognormal and Exponential Distributions \pause
  \item M3d: Binomial Distribution \pause
  \item M3e: Poisson Distribution \pause
  \item M3f: Joint Distributions and further topics
  \end{itemize}
\end{frame}
...
\begin{frame}{Cumulative distribution function (CDF)}
  The CDF of a random variable $X$ is given by\pause
  ...
  \item $F_X(x) \ge 0 \quad \forall x$ and is nondecreasing with $x$.

  \item $F_X(x)$ is continuous to the right with $x$.
  \end{enumerate}
  \pause

  Note that the symbol $\forall$ means ``for all''
\end{frame}
