...
\nin{\it \textbf{Due Tuesday, October 7, 2025 at 1:5900 PM as PDF uploaded on Canvas.}
...
\section*{Problem 3: Lognormal Distribution \textit{(5 points)}}
...
\section*{Problem 5: Exponential Distribution II \quad {\it  (4 points)}}
...
% \item Given that a family member has already waited for 1 hour, \pts{3}
