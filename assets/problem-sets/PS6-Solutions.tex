...
\begin{enumerate}[\bf (a)]
\item What population is under consideration in the data set? \boxed{\large \bl \textbf {i}}\pts{1}
\item What parameter is being estimated? \boxed{\large \bl \textbf {iv}} \pts{1}
\item What is the name of point estimate of the parameter? \boxed{\large \bl \textbf {ii}} \pts{1}
\item What is the name of the statistic that measures the uncertainty of the point estimate? \pts{1} \boxed{\large \bl \textbf {iii}} 
